locals {
  cpf_es_company_people_clusters = [
    "cpf-elasticsearch-company-people-prod-1",
    # "cpf-elasticsearch-company-people-prod-2",
  ]

  cpf_es_company_people_query_alert_monitors = [
    {
      name = "active shards"
  ...
  cpf_es_company_people_service_check_monitors = [
    {
      name = "cluster status"
  ...
  cpf_es_company_people_clusters_x_query_alert_monitors = [
    for pair in setproduct(local.cpf_es_company_people_clusters, local.cpf_es_company_people_query_alert_monitors) : merge(
      {
        cluster_name = pair[0]
      },
      pair[1]
  ...
  cpf_es_company_people_clusters_x_service_check_monitors = [
    for pair in setproduct(local.cpf_es_company_people_clusters, local.cpf_es_company_people_service_check_monitors) : merge(
      {
        cluster_name = pair[0]
      },
      pair[1]
