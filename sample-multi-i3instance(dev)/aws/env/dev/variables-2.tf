...
locals {
  elasticsearch_parameter_2 = {
    ...
    master_node_ips           = list("172.24.100.112", "172.24.108.114", "172.24.116.114")
    ...
    xpack_monitoring_exporters_my_remote_host                               = "cpf-elasticsearch-kensho-monitoring-indexing-2.dev.cpf.b12s.jp:9200"
