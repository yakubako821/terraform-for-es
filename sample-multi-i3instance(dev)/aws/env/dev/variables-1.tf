...
locals {
  elasticsearch_parameter_1 = {
    ...
    master_node_ips           = list("172.24.100.113", "172.24.108.113", "172.24.116.110")
    ...
    xpack_monitoring_exporters_my_remote_host                               = "cpf-elasticsearch-kensho-monitoring-indexing-1.dev.cpf.b12s.jp:9200"
