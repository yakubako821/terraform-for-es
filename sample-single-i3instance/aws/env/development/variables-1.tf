...
#    cluster_initial_master_nodes                                            = local.elasticsearch_parameter_1["discovery_type_single"] ? "" : "-E cluster.initial_master_nodes=${local.elasticsearch_parameter_1["master_node_ips"][0]}"
...
data "template_file" "container_definition_elasticsearch-data_1" {
  template = file("./container_definitions/container_definition_elasticsearch-single.json")
...
locals {
  elasticsearch_parameter_1 = {
    ...
    data_instance_type      = "i3.xlarge"
    data_autoscaling_size   = 1
    data_memory_reservation = 25600
