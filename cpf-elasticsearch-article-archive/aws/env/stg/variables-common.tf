...
locals {
  elasticsearch_name       = "${var.project_name}-elasticsearch-article"
  elasticsearch_short_name = "${var.project_name}-es-a"
}
...
#    alias_name                   = module.elasticsearch_lb_kibana_1.lb.dns_name
    alias_name                   = module.elasticsearch_lb_kibana_2.lb.dns_name
...
#    alias_name                   = module.elasticsearch_lb_coordinate_1.lb.dns_name
    alias_name                   = module.elasticsearch_lb_coordinate_2.lb.dns_name
