...
locals {
  elasticsearch_parameter_1 = {
    ...
    master_node_ips           = list("172.24.8.100", "172.24.24.100", "172.24.40.100")
    ...
    xpack_monitoring_exporters_my_remote_host                               = "cpf-elasticsearch-article-archive-monitoring-indexing-1.cpf.b12s.jp:9200"
