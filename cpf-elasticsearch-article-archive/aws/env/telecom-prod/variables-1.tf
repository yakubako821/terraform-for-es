...
locals {
  elasticsearch_parameter_1 = {
    ...
    master_node_ips           = list("172.24.8.102", "172.24.24.102")#, "172.24.40.101")
    ...
    xpack_monitoring_exporters_my_remote_host                               = "cpf-elasticsearch-tele-article-archive-monitoring-application.cpf.b12s.jp:9200"
