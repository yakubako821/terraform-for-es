...
#    master_node_ips           = list("172.24.100.211", "172.24.108.211") #, "172.24.84.110")
#    master_memory_reservation = 7368
...
#    listener_certificate_arn                      = "arn:aws:acm:ap-northeast-1:${data.aws_caller_identity.current.account_id}:certificate/e6fc49b7-5b5e-46e3-915a-1551c05e61f0"
#    target_type                                   = "instance"
