...
#    cluster_initial_master_nodes                                            = local.elasticsearch_parameter_2["discovery_type_single"] ? "" : "-E cluster.initial_master_nodes=${local.elasticsearch_parameter_2["master_node_ips"][0]},${local.elasticsearch_parameter_2["master_node_ips"][1]}"
...
#    master_node_ips           = list("172.24.68.210", "172.24.76.211") #, "172.24.84.211")
...
#    data_autoscaling_size   = 2
#    data_memory_reservation = 25000
#    data_es_java_opts       = "-XX:ActiveProcessorCount=4 -Xms16384m -Xmx16384m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
#
...
#
#    cluster_routing_allocation_awareness_force_aws_availability_zone_values = "ap-northeast-2a,ap-northeast-2c,ap-northeast-2d"
...
#    listener_certificate_arn                      = "arn:aws:acm:ap-northeast-2:${data.aws_caller_identity.current.account_id}:certificate/9b3082f7-9d43-4df5-806b-b19fcc56f5c4"
#    target_type                                   = "instance"
...
#  }
#
#  route53_record_parameter_indexing_2 = {
#    zone_id = "ZYDKLNLWW64QE"
#
#    name = "${local.elasticsearch_name}-indexing-2"
#    type = "A"
#
#    alias_name                   = module.elasticsearch_lb_data_2.lb.dns_name
