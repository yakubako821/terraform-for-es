...
##    master_node_ips           = list("172.24.100.110", "172.24.108.110", "172.24.116.110")
...
#    data_memory_reservation = 12288
#    data_es_java_opts       = "-XX:ActiveProcessorCount=8 -Xms4096m -Xmx4096m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
#
