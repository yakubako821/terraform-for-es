...
locals {
  elasticsearch_parameter_1 = {
    ...
    master_node_ips           = list("172.24.8.119", "172.24.24.119", "172.24.40.120")
    master_memory_reservation = 3072
    master_es_java_opts       = "-XX:ActiveProcessorCount=2 -Xms2048m -Xmx2048m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
    ...
    data_memory_reservation = 3072
    data_es_java_opts       = "-XX:ActiveProcessorCount=2 -Xms2048m -Xmx2048m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"

    kibana-and-coordinate_instance_type    = "c5.large"
    kibana-and-coordinate_autoscaling_size = 1
    coordinate_memory_reservation          = 2048
    kibana_memory_reservation              = 1024
    coordinate_es_java_opts                = "-XX:ActiveProcessorCount=2 -Xms2048m -Xmx2048m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
    ...
    xpack_monitoring_exporters_my_remote_host                               = "cpf-elasticsearch-article-recent-monitoring-application.cpf.b12s.jp:9200"
