...
#  template = file("./datadog_customized_log_definition/elasticsearch_log_conf.yaml")
#
#  vars = {
...
#  template = file("./ec2_user_data_definitions/ec2_user_data_elasticsearch-master.sh")
#
#  vars = {
...
#  template = file("./ec2_user_data_definitions/ec2_user_data_elasticsearch-data.sh")
#
#  vars = {
...
#  template = file("./ec2_user_data_definitions/ec2_user_data_elasticsearch-kibana-and-coordinate.sh")
#
#  vars = {
...
#  template = file("./container_definitions/container_definition_elasticsearch-master.json")
#
#  vars = {
...
#    cluster_initial_master_nodes                                            = local.elasticsearch_parameter_2["discovery_type_single"] ? "" : "-E cluster.initial_master_nodes=${local.elasticsearch_parameter_2["master_node_ips"][0]},${local.elasticsearch_parameter_1["master_node_ips"][1]},${local.elasticsearch_parameter_1["master_node_ips"][2]}"
...
#  template = file("./container_definitions/container_definition_elasticsearch-data.json")
#
#  vars = {
...
#  template = file("./container_definitions/container_definition_elasticsearch-coordinate.json")
#
#  vars = {
...
#  template = file("./container_definitions/container_definition_elasticsearch-kibana.json")
#
#  vars = {
...
#
#    ecr_name_elasticsearch = "vs-elasticsearch-company-people"
...
#    master_node_ips           = list("172.24.101.120", "172.24.109.120", "172.24.117.120")
#    master_memory_reservation = 7168
#    master_es_java_opts       = "-XX:ActiveProcessorCount=2 -Xms4300m -Xmx4300m -Xmn2150m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
#
#    data_instance_type      = "i3.large"
#    data_autoscaling_size   = 1
#    data_memory_reservation = 14592
#    data_es_java_opts       = "-XX:ActiveProcessorCount=2 -Xms9498m -Xmx9498m -Xmn4749m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
#
...
#    coordinate_es_java_opts                = "-XX:ActiveProcessorCount=2 -Xms2868m -Xmx2868m -Xmn1434m -XX:HeapDumpPath=/usr/share/elasticsearch/data -Xlog:gc*:file=/usr/share/elasticsearch/logs/gc_%p_%t.log::filecount=32,filesize=64m:time"
#
...
#    iam_instance_profile                 = "vs-elasticsearch-company-people-instance-profile"
#    key_name                             = "vs-elasticsearch-company-people-dev-key"
...
#    key_name      = "vs-elasticsearch-company-people-dev-key"
#
#    iam_instance_profile_name = "vs-elasticsearch-company-people-instance-profile"
...
#        device_index                = 0
#        associate_public_ip_address = false
#        security_groups             = [module.elasticsearch_security_group.security_group_id, module.elasticsearch_security_group_from-batch.security_group_id]
#      }
#    ]
#
#    tag_specifications = [
...
#    ecs_task_execution_role_arn    = "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/vs-elasticsearch-company-people-service-role"
